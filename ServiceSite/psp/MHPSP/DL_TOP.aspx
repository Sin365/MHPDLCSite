...
<form action="DL_BONUS.PHP" method=get>
		 <input type=image ANIME=20 alt="特典下載" width=186 height=30 >
		</form>
		
<form action="" method=get>
		 <input type=image ANIME=20 alt="關注皓月"  width=186 height=30 >
		</form>
	...
	<table width=244 bgcolor=black height=187 border=2 bordercolor=#1C64FE cellspacing=0>
		<tr>
			<td valign=top>
				<B>
				<center>
				<font color=orange>■配信服務繼續■</font><br>
				</center>
<BR>
卡普空官方於２０１４年９月３０日停止了配信服務<BR>
由皓月雲繼續提供配信服務<BR>
不忘初心、我愛ＭＨ<BR>
<BR>
Ｐｏｗｅｒｅｄ<BR>
...
<img src=PNG/B_START.PNG width=17 height=17>:退出配信服務    <form action="LD_TOP.PHP?u=0" method=get><input type="button">刷新</input></from>
